...
import SchoolLicense from "../../models/ejobs/eJobsAuth/SchoolAuth/SchoolLicense.js";
 ...
 export const PersonalDetailsLogic = async(req, res, next) => {
...
export const AddressLogic = async(req, res, next) => {
    console.log(req.body)
...
export const EducationLogic = async(req, res, next) => {
    console.log(req.body)
...
export const SchoolLicenseLogic = async(req, res, next) => {
    console.log(req.body)
