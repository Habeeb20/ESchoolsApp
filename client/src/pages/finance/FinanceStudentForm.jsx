...
//     const [name, setName] = useState('');
//     const [amountPaid, setAmountPaid] = useState('');
//     const [purpose, setPurpose] = useState(''); // Added purpose
//     const navigate = useNavigate();
...
//         try {
//             await axios.post('http://localhost:4000/api/financestudent', { name, amountPaid: Number(amountPaid), purpose });
//             setName('');
//             setAmountPaid('');
...
export default function FinanceStudentForm() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.post(
                'http://localhost:4000/api/financestudent', 
                { name, amountPaid: Number(amountPaid), purpose },
