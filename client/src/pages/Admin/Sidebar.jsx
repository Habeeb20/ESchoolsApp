    ...
    <SidebarNav>
      <SidebarNavItem>
        ...
        <SidebarNavItem>
          ...
          <StyledLink to="/adminclasses">Classes</StyledLink>
        </SidebarNavItem>
        <SidebarNavItem>
          <SidebarIcon><BsPeople /></SidebarIcon>
          <StyledLink to="/adminstudents">Students</StyledLink>
        </SidebarNavItem>
        <SidebarNavItem>
          <SidebarIcon><BsPerson /></SidebarIcon>
          <StyledLink to="/adminteachers">Teachers</StyledLink>
        </SidebarNavItem>
        {/* <SidebarNavItem> */}
        ...
        <SidebarNavItem>
          ...
          <StyledLink to="/adminattendance">Attendance</StyledLink>
        </SidebarNavItem>
        <SidebarNavItem>
          <SidebarIcon><BsBook /></SidebarIcon>
          <StyledLink to="/adminlibrary">Library</StyledLink>
        </SidebarNavItem>
        <SidebarNavItem>
