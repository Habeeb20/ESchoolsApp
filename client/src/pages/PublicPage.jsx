                        ...
                        <ul style={styles.list}>
                            {filteredSchools.map((school) => (
                                <li key={school._id} style={styles.item}>
                                    ...
                                    <p style={styles.detail}><strong>State:</strong> {school.location}</p>
                                    <p style={styles.detail}><strong>School fees  range:</strong> {school.schoolFees}</p>
                                    <p style={styles.detail}><strong>Local Government Area:</strong> {school.LGA}</p>
                                    <p style={styles.detail}><strong>Boarding:</strong> {school.onBoarding ? "yes, it is available" : 'not available'}</p>
                                    <p style={styles.detail}><strong>School Bus:</strong> {school.transportation ? "yes, it is available" : 'not available'}</p>
                                    {school.email && (
