    ...
    <SidebarContainer style={{ width: isOpen ? '250px' : '80px' }}>
      ...
      <SidebarNav>
        <SidebarNavItem>
          ...
          <StyledLink to="/studentdashboard">Dashboard</StyledLink>
        </SidebarNavItem>
        {/* <SidebarNavItem>
        ...
        <SidebarNavItem>
          ...
          <StyledLink to="/studentattendance">Attendance</StyledLink>
        </SidebarNavItem>
        <SidebarNavItem>
        <SidebarIcon><BsBook /></SidebarIcon>
          <StyledLink to="/studentlibrary">Library </StyledLink>
        </SidebarNavItem>
        <SidebarNavItem>
          <SidebarIcon><BsChatDots /></SidebarIcon>
          <StyledLink to="/studentannouncement">Announcement</StyledLink>
        </SidebarNavItem>
        <SidebarNavItem>
          <SidebarIcon><BsGear /></SidebarIcon>
          <StyledLink to="/studentprof">Profile</StyledLink>
        </SidebarNavItem>
