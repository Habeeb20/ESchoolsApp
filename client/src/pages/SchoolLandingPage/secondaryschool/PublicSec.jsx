...
export default function PublicSec() {
  ...
  const cardDetails = [
    { name: 'Government College Ibadan', description: 'A top-tier educational institution offering diverse programs.', link: '/valencia-schools' },
    { name: 'Lagos Secondary School', description: 'An esteemed school known for its excellence in academics.', link: '/st-catherine-schools' },
  ...
  return (
    <>
      ...
      <header style={headerStyle}>
        <h1>Public Secondary Schools</h1>
      </header>
